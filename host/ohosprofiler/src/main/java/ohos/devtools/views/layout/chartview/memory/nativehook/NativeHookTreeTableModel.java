...
public class NativeHookTreeTableModel extends DefaultTreeModel implements TreeTableModel, SortableColumnModel {
     ...
     */
    public NativeHookTreeTableModel(DefaultMutableTreeNode root, ColumnInfo[] columns) {
        super(root);
