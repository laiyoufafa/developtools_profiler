 ...
 * @since 2021/11/22
 */
public class HeapDumpTreeTableRowSorter<M extends TableModel> extends DefaultRowSorter<M, Integer> {
     ...
     * @param mode model
     */
    public HeapDumpTreeTableRowSorter(M mode) {
        treeTablemodel = mode;
     ...
     * @param tree tree
     */
    public static void sortDescTree(DefaultMutableTreeNode root, Comparator<TreeNode> condition, JTree tree) {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (nodeObj instanceof DefaultMutableTreeNode) {
                ...
                boolean rootFlag = (node.isRoot() || tree.isExpanded(tree.getRowForPath(path)) || !root.isRoot());
