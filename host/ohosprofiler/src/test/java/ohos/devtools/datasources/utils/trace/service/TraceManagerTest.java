...
public class TraceManagerTest {
        ...
        getFeatureImpl = new MockProfilerServiceImplBase() {
            ...
            public void fetchData(ProfilerServiceTypes.FetchDataRequest request,
                ...
                MemoryPluginResult.MemoryData aaa =
                    MemoryPluginResult.MemoryData.newBuilder().addProcessesinfo(processesInfo0)
                        .addProcessesinfo(processesInfo1).addProcessesinfo(processesInfo2).build();
    ...
    public void getSingletonTest() {
        ...
        Assert.assertNotNull(traceManager);
    }
    ...
    public void createSessionByTraceRequestTest() throws GrpcException {
        ...
        String sessionId = traceManager.createSessionByTraceRequest(deviceIPPortInfo, "idle", 5, 10, true);
    ...
    public void stopAndDestroySessionTest() throws GrpcException {
        ...
        ProfilerClient client = HiProfilerClient.getInstance().getProfilerClient("", 5001, channel);
        String sessionId = traceManager.createSessionByTraceRequest(deviceIPPortInfo, "idle", 5, 10, true);
        traceManager.stopAndDestroySession(deviceIPPortInfo, sessionId);
    }

    /**
     * TraceManager create Session Request Perfetto
     *
     * @tc.name: TraceManager createSessionRequestPerfetto
     * @tc.number: OHOS_JAVA_trace_TraceManager_getSingleton_0001
     * @tc.desc: TraceManager createSessionRequestPerfetto
     * @tc.type: functional testing
     * @tc.require: SR-032
     * @throws GrpcException GrpcException
     */
    @Test
    public void createSessionRequestPerfettoTest() throws GrpcException {
        TraceManager traceManager = TraceManager.getSingleton();
        ProfilerClient client = HiProfilerClient.getInstance().getProfilerClient("", 5001, channel);
        String sessionId = traceManager.createSessionRequestPerfetto(deviceIPPortInfo, "idle", 5, true);
        Assert.assertNotNull(sessionId);
    }
}
