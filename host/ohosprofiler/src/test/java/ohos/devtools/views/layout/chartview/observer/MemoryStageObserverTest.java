...
import ohos.devtools.views.layout.chartview.MemoryStageView;
...
/**
 * MemoryStageObserver test
 *
 * @since 2021/3/31 20:16
 */
public class MemoryStageObserverTest {
    ...
    private MemoryStageObserver observer;

    /**
     * functional test
     *
     * @tc.name: view chart
     * @tc.number: OHOS_JAVA_views_MemoryStageObserver_init_0001
    ...
    public void init() {
        ...
        for (IChartEventObserver event : observers) {
            if (event instanceof MemoryStageObserver) {
                observer = (MemoryStageObserver) event;
                break;
            }
        }
    }
     ...
     *
     * @tc.name: view chart
     * @tc.number: OHOS_JAVA_views_MemoryStageObserver_refreshStandard_0001
     * @tc.desc: chart Memory test
     * @tc.type: functional test
     * @tc.require: SR-001-AR-003
     */
     ...
     *
     * @tc.name: view chart
     * @tc.number: OHOS_JAVA_views_MemoryStageObserver_refreshView_0001
     * @tc.desc: chart Memory test
     * @tc.type: functional test
     * @tc.require: SR-001-AR-003
     */
