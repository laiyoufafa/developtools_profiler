...
/**
 * Memory Close Offline
 *
 * @since 2021/2/1 9:31
 */
public class MemoryCloseOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * memory Close Button Test
     *
     * @tc.name: memoryCloseButtonTest
     * @tc.number: OHOS_JAVA_memoryCloseButtonTest_0001
     * @tc.desc: memory Close Button Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void memoryCloseButtonTest() throws InterruptedException {
