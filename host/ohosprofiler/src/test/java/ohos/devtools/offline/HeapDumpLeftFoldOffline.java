...
/**
 * Heap Dump Left Fold Offline
 *
 * @since 2021/2/1 9:31
 */
public class HeapDumpLeftFoldOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * left Fold Offline Test
     *
     * @tc.name: leftFoldOfflineTest
     * @tc.number: OHOS_JAVA_leftFoldOfflineTest_0001
     * @tc.desc: left Fold Offline Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void leftFoldOfflineTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='TaskScenePanelChart']"))
            .button(byXpath("//div[@class='CustomJButton' and @name='jButtonLeft']"), Duration.ofSeconds(2)).click();
