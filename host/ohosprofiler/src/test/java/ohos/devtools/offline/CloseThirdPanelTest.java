...
/**
 * Close heap dump third panel test
 *
 * @since 2021/2/1 9:31
 */
public class CloseThirdPanelTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * close Third Panel Test
     *
     * @tc.name: closeThirdPanelTest
     * @tc.number: OHOS_JAVA_closeThirdPanelTest_0001
     * @tc.desc: closeHeapTableTest
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void closeThirdPanelTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='JBLabel' and @name='closeThirdPanel']"))
            .click();
