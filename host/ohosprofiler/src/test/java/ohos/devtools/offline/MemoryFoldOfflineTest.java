...
/**
 * Off-Line Memory Fold Test
 *
 * @since 2021/2/1 9:31
 */
public class MemoryFoldOfflineTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * memory Fold Button Test
     *
     * @tc.name: memoryFoldButtonTest
     * @tc.number: OHOS_JAVA_memoryFoldButton_0001
     * @tc.desc: memory Fold Button Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void memoryFoldButton() throws InterruptedException {
