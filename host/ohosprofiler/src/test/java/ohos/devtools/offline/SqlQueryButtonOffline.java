...
/**
 * Sql Query Button Offline
 *
 * @since 2021/2/1 9:31
 */
public class SqlQueryButtonOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * sql Query Button Test
     *
     * @tc.name: sqlQueryButtonTest
     * @tc.number: OHOS_JAVA_sqlQueryButtonTest_0001
     * @tc.desc: sql Query Button Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void sqlQueryButtonTest() throws InterruptedException {
