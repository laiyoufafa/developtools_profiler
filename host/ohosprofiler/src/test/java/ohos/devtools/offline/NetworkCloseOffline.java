...
/**
 * Network Close Offline
 *
 * @since 2021/2/1 9:31
 */
public class NetworkCloseOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * network Close Button Test
     *
     * @tc.name: networkCloseButtonTest
     * @tc.number: OHOS_JAVA_networkCloseButtonTest_0001
     * @tc.desc: network Close Button Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void networkCloseButtonTest() throws InterruptedException {
