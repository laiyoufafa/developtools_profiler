 ...
 * @since 2021/2/1 9:31
 */
public class EnergyFoldOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * energy Fold Button off-line Test
     *
     * @tc.name: energyFoldButtonTest
     * @tc.number: OHOS_JAVA_energyFoldButtonTest_0001
     * @tc.desc: energy Fold Button Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void energyFoldButtonTest() throws InterruptedException {
