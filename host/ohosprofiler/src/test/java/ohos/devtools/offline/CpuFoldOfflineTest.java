...
/**
 * OffLine Cpu Fold Test
 *
 * @since 2021/2/1 9:31
 */
public class CpuFoldOfflineTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * cpu Fold Button Test
     *
     * @tc.name: cpuFoldButtonTest
     * @tc.number: OHOS_JAVA_cpuFoldButton_0001
     * @tc.desc: cpu Fold Button Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void cpuFoldButton() throws InterruptedException {
