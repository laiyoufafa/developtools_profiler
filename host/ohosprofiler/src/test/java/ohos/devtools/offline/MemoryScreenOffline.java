...
/**
 * Memory Screen Offline
 *
 * @since 2021/2/1 9:31
 */
public class MemoryScreenOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * memory Screen Test
     *
     * @tc.name: memoryScreenTest
     * @tc.number: OHOS_JAVA_memoryScreenTest_0001
     * @tc.desc: memory Screen Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void memoryScreenTest() throws InterruptedException {
        ...
        remoteRobot
            ...
            .jLabel(byXpath("//div[@class='JBLabel' and @name='detailCfgBtn']"), Duration.ofSeconds(2)).click();
        // top close
