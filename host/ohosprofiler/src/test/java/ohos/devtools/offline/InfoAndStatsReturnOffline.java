...
/**
 * Info And Stats Return Offline
 *
 * @since 2021/2/1 9:31
 */
public class InfoAndStatsReturnOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * info And Stats Return Test
     *
     * @tc.name: infoAndStatsReturnTest
     * @tc.number: OHOS_JAVA_infoAndStatsReturnTest_0001
     * @tc.desc: info And Stats Return Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void infoAndStatsReturnTest() throws InterruptedException {
