...
/**
 * Heap Dump Filter Test
 *
 * @since 2021/2/1 9:31
 */
public class HeapDumpFilterTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * heap Dump Filter Test
     *
     * @tc.name: heapDumpFilterTest
     * @tc.number: OHOS_JAVA_heapDumpFilterTest_0001
     * @tc.desc: heap Dump Filter Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void heapDumpFilterTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='FilterHeaps']"))
            .comboBox(byXpath("//div[@class='CustomComboBox' and @name='jComboBoxFilter']"), Duration.ofSeconds(2))
            .selectItem("View image heap");
        TimeUnit.SECONDS.sleep(5);
        // top close
