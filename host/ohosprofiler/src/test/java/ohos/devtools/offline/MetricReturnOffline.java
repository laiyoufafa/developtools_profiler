...
/**
 * Metric Return Offline
 *
 * @since 2021/2/1 9:31
 */
public class MetricReturnOffline {
    ...
    public void metricsReturnTest() throws InterruptedException {
        remoteRobot.find(CommonContainerFixture.class, Locators.byXpath("//div[@class='WelcomePanel']")).button(Locators
            .byXpath("//div[@accessiblename=' + New Task' and @class='JBLabel' and @name='newTaskBtn' "
                + "and @text=' + New Task']"), Duration.ofSeconds(2)).click();
