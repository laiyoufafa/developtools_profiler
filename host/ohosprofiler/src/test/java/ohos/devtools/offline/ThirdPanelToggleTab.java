...
/**
 * heap dump third panel toggle tab
 *
 * @since 2021/2/1 9:31
 */
public class ThirdPanelToggleTab {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * third Panel Toggle Tab
     *
     * @tc.name: thirdPanelToggleTab
     * @tc.number: OHOS_JAVA_thirdPanelToggleTab_0001
     * @tc.desc: third Panel Toggle Tab
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void thirdPanelToggleTab() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='HomePanel']")).button(byXpath(
            ...
            Duration.ofSeconds(2)).click();
        String resource = this.getClass().getResource("/Demo.hprof").toString();
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='Table']")).click();
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='JBTable']")).click();
        remoteRobot.find(CommonContainerFixture.class, byXpath(
            "//div[@accessiblename='         References' and @class='JBLabel' and @text='         References']"))
            .click();
