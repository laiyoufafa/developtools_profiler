...
/**
 * Energy Tool Tip Offline
 *
 * @since 2021/2/1 9:31
 */
public class EnergyToolTipOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * energy Tool Tip Test
     *
     * @tc.name: energyToolTipTest
     * @tc.number: OHOS_JAVA_energyToolTipTest_0001
     * @tc.desc: energy Tool Tip Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void energyToolTipTest() throws InterruptedException {
