...
/**
 * metric  button switch offline
 *
 * @since 2021/2/1 9:31
 */
public class ButtonSwitchOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * button Switch Offline
     *
     * @tc.name: buttonSwitchOffline
     * @tc.number: OHOS_JAVA_buttonSwitchOffline_0001
     * @tc.desc: button Switch Offline
