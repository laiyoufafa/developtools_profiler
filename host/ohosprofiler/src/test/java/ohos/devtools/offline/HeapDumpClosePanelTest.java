...
/**
 * Heap Dump Close Panel Test
 *
 * @since 2021/2/1 9:31
 */
public class HeapDumpClosePanelTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * close Panel Test
     *
     * @tc.name: closePanelTest
     * @tc.number: OHOS_JAVA_closePanelTest_0001
     * @tc.desc: close Panel Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void closePanelTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='HeapTablePanel']"))
            .jLabel(byXpath("//div[@class='JLabel' and @name='closeLabel']"), Duration.ofSeconds(2)).click();
