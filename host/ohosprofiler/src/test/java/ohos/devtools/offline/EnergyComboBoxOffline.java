...
/**
 * Energy Combo Box Offline
 *
 * @since 2021/2/1 9:31
 */
public class EnergyComboBoxOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * energy ComboBox Test
     *
     * @tc.name: energyComboBoxTest
     * @tc.number: OHOS_JAVA_energyComboBoxTest_0001
     * @tc.desc: energy ComboBox Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void energyComboBoxTest() throws InterruptedException {
        ...
        remoteRobot
            .find(CommonContainerFixture.class, byXpath("//div[@class='CustomComboBox' and @name='energyViewBox']"))
            .click();
