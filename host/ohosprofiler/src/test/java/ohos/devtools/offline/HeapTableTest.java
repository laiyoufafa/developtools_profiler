 ...
 * @since 2021/2/1 9:31
 */
public class HeapTableTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * heap Table Test
     *
     * @tc.name: heapTableTest
     * @tc.number: OHOS_JAVA_heapTableTest_0001
     * @tc.desc: heap Table Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void heapTableTest() throws InterruptedException {
