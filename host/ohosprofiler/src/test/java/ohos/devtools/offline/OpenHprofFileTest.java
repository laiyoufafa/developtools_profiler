...
/**
 * Open Hprof File Test
 *
 * @since 2021/2/1 9:31
 */
public class OpenHprofFileTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * open Hprof File Test
     *
     * @tc.name: openHprofFileTest
     * @tc.number: OHOS_JAVA_openHprofFileTest_0001
     * @tc.desc: openHprofFileTest
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void openHprofFileTest() throws InterruptedException {
