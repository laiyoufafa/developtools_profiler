...
/**
 * Energy View Box Offline
 *
 * @since 2021/2/1 9:31
 */
public class EnergyViewBoxOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * energy View Box Test
     *
     * @tc.name: energyViewBoxTest
     * @tc.number: OHOS_JAVA_energyViewBoxTest_0001
     * @tc.desc: energy View Box Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void energyViewBoxTest() throws InterruptedException {
