...
/**
 * Memory Array Box Offline
 *
 * @since 2021/2/1 9:31
 */
public class MemoryArrayBoxOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * memory Array Box View
     *
     * @tc.name: memoryArrayBoxView
     * @tc.number: OHOS_JAVA_memoryArrayBoxView_0001
     * @tc.desc: memory Array Box View
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void memoryArrayBoxView() throws InterruptedException {
        ...
        remoteRobot
            ...
            .click();
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='CustomComboBox' and @name='arrangeBox']"))
            .click();
