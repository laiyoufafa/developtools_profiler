...
/**
 * Close Network View Offline
 *
 * @since 2021/2/1 9:31
 */
public class CloseNetworkViewOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * close Network Second Box Test
     *
     * @tc.name: closeNetworkSecondBoxTest
     * @tc.number: OHOS_JAVA_closeNetworkSecondBoxTest_0001
     * @tc.desc: closeNetworkSecondBoxTest
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void closeNetworkSecondBoxTest() throws InterruptedException {
