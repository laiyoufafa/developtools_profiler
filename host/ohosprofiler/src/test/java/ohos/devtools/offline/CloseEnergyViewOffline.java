...
/**
 * Close Energy View Offline
 *
 * @since 2021/2/1 9:31
 */
public class CloseEnergyViewOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * close Energy Second Box Test
     *
     * @tc.name: closeEnergySecondBoxTest
     * @tc.number: OHOS_JAVA_closeEnergySecondBoxTest_0001
     * @tc.desc: closeEnergySecondBoxTest
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void closeEnergySecondBoxTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='EnergyItemView']"))
            .jLabel(byXpath("//div[@class='JBLabel' and @name='energyFoldBtn']"), Duration.ofSeconds(2)).click();
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='EnergyItemView']")).click();
        TimeUnit.SECONDS.sleep(2);
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='EnergyItemView']")).rightClick();
