...
/**
 * Network Fold Offline
 *
 * @since 2021/2/1 9:31
 */
public class NetworkFoldOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * network Fold Button Test
     *
     * @tc.name: networkFoldButtonTest
     * @tc.number: OHOS_JAVA_networkFoldButtonTest_0001
     * @tc.desc: network Fold Button Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void networkFoldButtonTest() throws InterruptedException {
