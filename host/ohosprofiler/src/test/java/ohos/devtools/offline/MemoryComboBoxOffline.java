...
/**
 * Memory ComboBox Offline
 *
 * @since 2021/2/1 9:31
 */
public class MemoryComboBoxOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * memory ComboBox Test
     *
     * @tc.name: memoryComboBoxTest
     * @tc.number: OHOS_JAVA_memoryComboBoxTest_0001
     * @tc.desc: memory ComboBox Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void memoryComboBoxTest() throws InterruptedException {
        ...
        remoteRobot
            ...
            .click();
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='CustomComboBox' and @name='viewBox']"))
            .click();
