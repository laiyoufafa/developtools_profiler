...
/**
 * Heap Dump Search Test
 *
 * @since 2021/2/1 9:31
 */
public class HeapDumpSearchTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * heap Dump Search Test
     *
     * @tc.name: heapDumpSearchTest
     * @tc.number: OHOS_JAVA_heapDumpSearchTest_0001
     * @tc.desc: heapDumpSearchTest
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void heapDumpSearchTest() throws InterruptedException {
        ...
        remoteRobot
            .find(CommonContainerFixture.class, byXpath("//div[@class='FilterHeaps']"))
            .textField(byXpath("//div[@class='CustomJBTextField' and @name='heapDumpSearch']"), Duration.ofSeconds(2))
            .setText("java");
