...
/**
 * Close Heap Table Test
 *
 * @since 2021/2/1 9:31
 */
public class CloseHeapTableTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * close Heap Table Test
     *
     * @tc.name: closeHeapTableTest
     * @tc.number: OHOS_JAVA_closeHeapTableTest_0001
     ...
     */
    @Test
    public void closeHeapTableTest() throws InterruptedException {
