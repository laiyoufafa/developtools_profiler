...
/**
 * Heap Dump Third Panel Test
 *
 * @since 2021/2/1 9:31
 */
public class HeapDumpThirdPanelTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * heap Dump Third Panel Test
     *
     * @tc.name: heapDumpThirdPanelTest
     * @tc.number: OHOS_JAVA_heapDumpThirdPanelTest_0001
     * @tc.desc: heap Dump Third Panel Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void heapDumpThirdPanelTest() throws InterruptedException {
