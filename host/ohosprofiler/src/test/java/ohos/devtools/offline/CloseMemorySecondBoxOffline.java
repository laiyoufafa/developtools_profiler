...
/**
 * Off Line Close Memory Second Box
 *
 * @since 2021/2/1 9:31
 */
public class CloseMemorySecondBoxOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * close Memory Second Box
     *
     * @tc.name: closeMemorySecondBox
     * @tc.number: OHOS_JAVA_closeMemorySecondBox_0001
     * @tc.desc: close Memory Second Box
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void closeMemorySecondBox() throws InterruptedException {
