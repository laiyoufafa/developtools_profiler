...
/**
 * Heap Dump Leaks Test
 *
 * @since 2021/2/1 9:31
 */
public class HeapDumpLeaksTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * heap Dump Leaks Test
     *
     * @tc.name: heapDumpLeaksTest
     * @tc.number: OHOS_JAVA_heapDumpLeaksTest_0001
     * @tc.desc: heap Dump Leaks Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void heapDumpLeaksTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='FilterHeaps']"))
            .jLabel(byXpath("//div[@accessiblename='Leaks' and @class='CustomJUnderLineLabel' and @text='Leaks']"),
                Duration.ofSeconds(2)).click();
