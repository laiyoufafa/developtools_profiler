...
/**
 * Off Line Memory Tool Tip
 *
 * @since 2021/2/1 9:31
 */
public class MemoryToolTipOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * memory Tool Tips
     *
     * @tc.name: memoryToolTipTest
     * @tc.number: OHOS_JAVA_memoryToolTipTest_0001
     * @tc.desc: memory Tool Tips
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void memoryToolTipTest() throws InterruptedException {
