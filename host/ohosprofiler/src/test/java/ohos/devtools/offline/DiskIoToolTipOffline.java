...
/**
 * DiskIo Tool Tip Offline
 *
 * @since 2021/2/1 9:31
 */
public class DiskIoToolTipOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * diskIo Tool Tips Test
     *
     * @tc.name: diskIoToolTipsTest
     * @tc.number: OHOS_JAVA_diskIoToolTipsTest_0001
     * @tc.desc: diskIo Tool Tips Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void diskIoToolTipsTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='DiskIoView']"))
            .jLabel(byXpath("//div[@class='JBLabel' and @name='diskIoFoldBtn']"), Duration.ofSeconds(2)).click();
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='DiskIoView' and @name='DiskIoItemView']"))
            .rightClick();
