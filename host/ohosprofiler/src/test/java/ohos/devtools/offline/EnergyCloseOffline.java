...
/**
 * Energy Close Offline
 *
 * @since 2021/2/1 9:31
 */
public class EnergyCloseOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * energy Close Button Test
     *
     * @tc.name: energyCloseButtonTest
     * @tc.number: OHOS_JAVA_energyCloseButtonTest_0001
     * @tc.desc: energy Close Button Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void energyCloseButtonTest() throws InterruptedException {
