...
/**
 * open trace file test
 *
 * @since 2021/2/1 9:31
 */
public class OpenTraceFileTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * open Trace File Test
     *
     * @tc.name: openTraceFileTest
     * @tc.number: OHOS_JAVA_openTraceFileTest_0001
     * @tc.desc: openTraceFileTest
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void openTraceFileTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='HomePanel']")).button(byXpath(
            ...
            Duration.ofSeconds(2)).click();
        String resource = this.getClass().getResource("/PerfDemo.trace").toString();
