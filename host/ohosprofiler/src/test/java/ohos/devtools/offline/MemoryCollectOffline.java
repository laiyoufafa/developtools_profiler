...
/**
 * Memory Collect Off-line
 *
 * @since 2021/2/1 9:31
 */
public class MemoryCollectOffline {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * memory Collect Box Test
     *
     * @tc.name: memoryCollectBoxTest
     * @tc.number: OHOS_JAVA_memoryCollectBoxTest_0001
     * @tc.desc: memory Collect Box Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void memoryCollectBoxTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='ComboBox' and @name='collectBox']"))
            .click();
        TimeUnit.SECONDS.sleep(2);
        // top close
