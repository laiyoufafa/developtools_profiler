...
/**
 * Java Agent ComboBox Fixture Test
 *
 * @since 2021/2/1 9:31
 */
public class JavaAgentComboBoxFixtureTest {
    ...
    public void testWindow() throws InterruptedException {
        ...
        // JAVA Agent data
        frameFixture.panel(UtConstant.UT_MEMORY_ITEM_VIEW).click();
        String[] viewBoxes = frameFixture.comboBox(UtConstant.UT_MEMORY_TREE_TABLE_VIEW).contents();
        Assert.assertEquals(viewBoxes[0], "View app heaps");
        String[] arrangeBoxes = frameFixture.comboBox(UtConstant.UT_MEMORY_TREE_TABLE_ARRANGE).contents();
        Assert.assertEquals(arrangeBoxes[0], "Arrange by class");
