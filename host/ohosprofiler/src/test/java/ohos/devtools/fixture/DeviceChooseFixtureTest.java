...
/**
 * Device Choose Fixture Test
 *
 * @since 2021/2/1 9:31
 */
public class DeviceChooseFixtureTest {
    ...
    public void testWindow() throws InterruptedException {
        ...
        frameFixture.comboBox(UtConstant.UT_DEVICE_PROCESS_PANEL_DEVICE_NAME).selectItem(0);
        int deviceTotal = frameFixture.comboBox(UtConstant.UT_DEVICE_PROCESS_PANEL_DEVICE_NAME).contents().length;
        Assert.assertEquals(1, deviceTotal);
