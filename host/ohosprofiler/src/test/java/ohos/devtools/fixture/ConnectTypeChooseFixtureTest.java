...
/**
 * Connect Type Choose Fixture Test
 *
 * @since 2021/2/1 9:31
 */
public class ConnectTypeChooseFixtureTest {
    ...
    public void testWindow() throws InterruptedException {
        ...
        // RPC communication via USB
        String[] contents = frameFixture.comboBox(UtConstant.UT_DEVICE_PROCESS_PANEL_CONNECT_TYPE).contents();
        Assert.assertEquals(contents[0], "USB");
        frameFixture.comboBox(UtConstant.UT_DEVICE_PROCESS_PANEL_CONNECT_TYPE).selectItem(LayoutConstants.USB);
