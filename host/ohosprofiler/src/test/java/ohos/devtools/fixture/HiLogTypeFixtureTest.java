...
/**
 * HiLog Type Fixture Test
 *
 * @since 2021/2/1 9:31
 */
public class HiLogTypeFixtureTest {
    ...
    public void testWindow() throws InterruptedException {
        try {
            frameFixture.menuItem(UtConstant.UT_HOME_PANEL_HILOG_MENU).click();
        } catch (ActionFailedException exception) {
            exception.printStackTrace();
        }
        frameFixture.panel(UtConstant.UT_HILOG_PANEL_TITLE_LEFT).click();
        frameFixture.comboBox(UtConstant.UT_HILOG_PANEL_DEVICE).click();
        frameFixture.comboBox(UtConstant.UT_HILOG_PANEL_DEVICE).selectItem(1);
        frameFixture.comboBox(UtConstant.UT_HILOG_PANEL_LOG_TYPE).click();
        frameFixture.comboBox(UtConstant.UT_HILOG_PANEL_LOG_TYPE).selectItem(0);
        TimeUnit.SECONDS.sleep(5);
        TimeUnit.SECONDS.sleep(2);
        frameFixture.panel(UtConstant.UT_HILOG_PANEL_CLOSE_RIGHT).click();
    }
