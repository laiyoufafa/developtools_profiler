...
/**
 * Application Turning Fixture Test
 *
 * @since 2021/2/1 9:31
 */
public class ApplicationTurningFixtureTest {
    ...
    public void testWindow() throws InterruptedException {
        ...
        String text = frameFixture.label(UtConstant.UT_TASK_PANEL_APPLICATION).text();
        Assert.assertEquals(text, "Application Tuning");
