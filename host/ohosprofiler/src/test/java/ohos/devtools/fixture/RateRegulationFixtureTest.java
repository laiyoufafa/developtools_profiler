 ...
 * @since 2021/2/1 9:31
 */
public class RateRegulationFixtureTest {
    ...
    public void testWindow() throws InterruptedException {
        ...
        TimeUnit.SECONDS.sleep(5);
        frameFixture.comboBox(UtConstant.UT_TASK_SCENE_PANEL_CHART_TIME).click();
        frameFixture.comboBox(UtConstant.UT_TASK_SCENE_PANEL_CHART_TIME).selectItem(0);
        TimeUnit.SECONDS.sleep(5);
