...
/**
 * Distributed Toggle Tab Test
 *
 * @since 2021/2/1 9:31
 */
public class DistributedToggleTabTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * distributed Scene
     *
     * @tc.name: distributedScene
     * @tc.number: OHOS_JAVA_distributedScene_0001
     ...
     */
    @Test
    public void distributedScene() throws InterruptedException {
