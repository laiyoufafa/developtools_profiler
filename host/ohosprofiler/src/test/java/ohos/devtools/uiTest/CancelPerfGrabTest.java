...
/**
 * Cancel Perf Data Grab
 *
 * @since 2021/2/1 9:31
 */
public class CancelPerfGrabTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * Cancel Perf Grab Test
     *
     * @tc.name: CancelPerfGrabTest
     * @tc.number: OHOS_JAVA_CancelPerfGrabTest_0001
     * @tc.desc: Cancel Perf Grab Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void cancelPerfGrabTest() throws InterruptedException {
