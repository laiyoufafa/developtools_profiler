 ...
 * @since 2021/2/1 9:31
 */
public class EnergySceneTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * energy Scene Test
     *
     * @tc.name: energySceneTest
     * @tc.number: OHOS_JAVA_energySceneTest_0001
     * @tc.desc: energy Scene Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void energySceneTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='TaskScenePanelChart']"))
            .button(byXpath("//div[@class='CustomJButton' and @name='jButtonStop']"), Duration.ofSeconds(2)).click();
