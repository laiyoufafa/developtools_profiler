...
/**
 * DiskIo Close Button Test
 *
 * @since 2021/2/1 9:31
 */
public class DiskIoCloseButtonTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * diskIo close
     *
     * @tc.name: diskIoCloseTest
     * @tc.number: OHOS_JAVA_diskIoCloseTest_0001
     * @tc.desc: diskIo close
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void diskIoCloseTest() throws InterruptedException {
