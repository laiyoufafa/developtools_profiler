...
/**
 * System Grab Categories Test
 *
 * @since 2021/2/1 9:31
 */
public class SystemGrabCategoriesTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * system Grab Categories Test
     *
     * @tc.name: systemGrabCategoriesTest
     * @tc.number: OHOS_JAVA_systemGrabCategoriesTest_0001
     * @tc.desc: system Grab Categories Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void systemGrabCategoriesTest() throws InterruptedException {
