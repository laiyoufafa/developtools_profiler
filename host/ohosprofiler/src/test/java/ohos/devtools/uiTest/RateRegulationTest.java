...
/**
 * rate regulation test
 *
 * @since 2021/2/1 9:31
 */
public class RateRegulationTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * rate Regulation Test
     *
     * @tc.name: rateRegulationTest
     * @tc.number: OHOS_JAVA_rateRegulationTest_0001
     * @tc.desc: rate Regulation Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void rateRegulationTest() throws InterruptedException {
        ...
        // rate regulation
        remoteRobot
            .find(CommonContainerFixture.class, byXpath("//div[@class='CustomComboBox' and @name='timeJComboBox']"))
            .click();
        // top close
