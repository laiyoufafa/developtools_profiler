 ...
 * @since 2021/2/1 9:31
 */
public class SelectMetricTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * select Metric Test
     *
     * @tc.name: selectMetricTest
     * @tc.number: OHOS_JAVA_selectMetricTest_0001
     * @tc.desc: select Metric Test
    ...
    public void selectMetricTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='HomePanel']")).jLabel(byXpath(
            "//div[@accessiblename='System Tuning' "
                + "and @class='JBLabel' and @name='System Tuning' and @text='System Tuning']"),
            Duration.ofSeconds(2)).click();
