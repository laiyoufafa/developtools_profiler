...
public class SearchProcessTest {
     ...
     * search Process Test
     *
     * @tc.name: searchProcessTest
     * @tc.number: OHOS_JAVA_searchProcessTest_0001
     * @tc.desc: search Process Test
    ...
    public void searchProcessTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='HomePanel']")).jLabel(byXpath(
            "//div[@accessiblename='Application Tuning' and @class='JBLabel' and @name='Application Tuning' "
                + "and @text='Application Tuning']"), Duration.ofSeconds(2)).click();
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='DeviceProcessPanel']"))
            .textField(byXpath("//div[@class='CustomTextField' and @name='searchField']"), Duration.ofSeconds(2))
            .setText("kth");
