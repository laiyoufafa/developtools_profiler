...
/**
 * Memory View Box Test
 *
 * @since 2021/2/1 9:31
 */
public class MemoryViewBoxTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * memory View Box Test
     *
     * @tc.name: memoryViewBoxTest
     * @tc.number: OHOS_JAVA_memoryViewBoxTest_0001
     * @tc.desc: memory View Box Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void memoryViewBoxTest() throws InterruptedException {
