 ...
 * @since 2021/2/1 9:31
 */
public class MemorySceneTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * Memory Scene Test
     *
     * @tc.name: memorySceneTest
     * @tc.number: OHOS_JAVA_memorySceneTest_0001
     * @tc.desc: Memory Scene Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void memorySceneTest() throws InterruptedException {
