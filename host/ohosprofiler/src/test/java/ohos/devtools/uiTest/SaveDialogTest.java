...
public class SaveDialogTest {
     ...
     * save Dialog Test
     *
     * @tc.name: saveDialogTest
     * @tc.number: OHOS_JAVA_saveDialogTest_0001
     * @tc.desc: save Dialog Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void saveDialogTest() throws InterruptedException {
        ...
        remoteRobot
            ...
            .textField(byXpath("//div[@class='JTextField' and @name='fileName']"), Duration.ofSeconds(2))
            .setText("111");
        remoteRobot
            .find(CommonContainerFixture.class, byXpath("//div[@accessiblename='Export As' and @class='MyDialog']"))
