...
public class DeviceNameTest {
     ...
     * device Name Test
     *
     * @tc.name: deviceNameTest
     * @tc.number: OHOS_JAVA_deviceNameTest_0001
     * @tc.desc: device Name Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void deviceNameTest() throws InterruptedException {
        ...
        remoteRobot
            .find(CommonContainerFixture.class, byXpath("//div[@class='ComboBox' and @name='deviceNameComboBox']"))
            .click();
