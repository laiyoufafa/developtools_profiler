...
/**
 * Cancel Delete Dialog Test
 *
 * @since 2021/2/1 9:31
 */
public class CancelDeleteDialogTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * cancel Delete Dialog Test
     *
     * @tc.name: cancelDeleteDialogTest
     * @tc.number: OHOS_JAVA_cancelDeleteDialogTest_0001
     * @tc.desc: cancel Delete Dialog Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void cancelDeleteDialogTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='TaskScenePanelChart']"))
            .button(byXpath("//div[@class='CustomJButton' and @name='jButtonDelete']"), Duration.ofSeconds(2)).click();
        // delete dialog
