...
/**
 * Ability Tool Tips Test
 *
 * @since 2021/2/1 9:31
 */
public class AbilityToolTipsTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * Ability Tool Tips Test
     *
     * @tc.name: abilityToolTipsTest
     * @tc.number: OHOS_JAVA_abilityToolTipsTest_0001
     * @tc.desc: Ability Tool Tips Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void abilityToolTipsTest() throws InterruptedException {
        ...
        TimeUnit.SECONDS.sleep(10);
        remoteRobot
            .find(CommonContainerFixture.class, byXpath("//div[@class='ProfilerAppAbility' and @name='abilitySlice']"))
            .click();
