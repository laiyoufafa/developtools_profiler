...
/**
 * Cpu Close Button Test
 *
 * @since 2021/2/1 9:31
 */
public class CpuCloseButtonTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * Cpu Close Button Test
     *
     * @tc.name: CpuCloseButtonTest
     * @tc.number: OHOS_JAVA_CpuCloseButtonTest_0001
     * @tc.desc: Cpu Close Button Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void CpuCloseButtonTest() throws InterruptedException {
