 ...
 * @since 2021/2/1 9:31
 */
public class NetworkSceneTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * Network Scene Test
     *
     * @tc.name: netWorkSceneTest
     * @tc.number: OHOS_JAVA_netWorkSceneTest_0001
     * @tc.desc: Network Scene Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void netWorkSceneTest() throws InterruptedException {
