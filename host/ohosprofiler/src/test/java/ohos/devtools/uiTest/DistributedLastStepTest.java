...
/**
 * Distributed Last Step Test
 *
 * @since 2021/2/1 9:31
 */
public class DistributedLastStepTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * distributed Last Step Test
     *
     * @tc.name: distributedLastStepTest
     * @tc.number: OHOS_JAVA_distributedLastStepTest_0001
     * @tc.desc: distributed Scene
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void distributedLastStepTest() throws InterruptedException {
