...
/**
 * Metric Run Button Test
 *
 * @since 2021/2/1 9:31
 */
public class MetricRunButtonTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * Metric Run Button Test
     *
     * @tc.name: MetricRunButtonTest
     * @tc.number: OHOS_JAVA_MetricRunButtonTest_0001
     * @tc.desc: Metric Run Button Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void MetricRunButtonTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='MetricsPanel']"))
            .button(byXpath("//div[@accessiblename='Run' and @class='JButton' and @name='metricsRun' and @text='Run']"),
                Duration.ofSeconds(2)).click();
        TimeUnit.SECONDS.sleep(5);
        // top close
