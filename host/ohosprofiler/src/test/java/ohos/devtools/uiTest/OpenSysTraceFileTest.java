...
public class OpenSysTraceFileTest {
     ...
     * open System Trace File Test
     *
     * @tc.name: openSysTraceFileTest
     * @tc.number: OHOS_JAVA_openSysTraceFileTest_0001
     * @tc.desc: open System Trace File Test
    ...
    public void openSysTraceFileTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class,
            byXpath("//div[@accessiblename='Please Choose the type' and @class='MyDialog']"))
            .button(byXpath("//div[@accessiblename='OK' and @class='JButton' and @text='OK']"), Duration.ofSeconds(2))
            .click();
