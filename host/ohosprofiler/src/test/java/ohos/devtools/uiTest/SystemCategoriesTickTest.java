...
/**
 * System Grab Categories Tick Test
 *
 * @since 2021/2/1 9:31
 */
public class SystemCategoriesTickTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * system Categories Tick Test
     *
     * @tc.name: systemCategoriesTickTest
     * @tc.number: OHOS_JAVA_systemCategoriesTickTest_0001
     * @tc.desc: system Categories Tick Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void systemCategoriesTickTest() throws InterruptedException {
