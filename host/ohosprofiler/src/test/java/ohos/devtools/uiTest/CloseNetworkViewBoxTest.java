...
/**
 * Close Network ViewBox Test
 *
 * @since 2021/2/1 9:31
 */
public class CloseNetworkViewBoxTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * close Network View Box
     *
     * @tc.name: closeNetworkViewBoxTest
     * @tc.number: OHOS_JAVA_closeNetworkViewBoxTest_0001
     * @tc.desc: close Network View Box
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void closeNetworkViewBoxTest() throws InterruptedException {
