 ...
 * @since 2021/2/1 9:31
 */
public class SystemStartTaskTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * system Start Test
     *
     * @tc.name: systemStartTest
     * @tc.number: OHOS_JAVA_systemStartTest_0001
     * @tc.desc: system Start Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void systemStartTest() throws InterruptedException {
