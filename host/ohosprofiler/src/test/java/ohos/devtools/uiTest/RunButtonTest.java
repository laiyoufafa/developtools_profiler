...
public class RunButtonTest {
     ...
     * Run Button Test
     *
     * @tc.name: RunButtonTest
     * @tc.number: OHOS_JAVA_RunButtonTest_0001
     * @tc.desc: Run Button Test
    ...
    public void RunButtonTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='TaskScenePanelChart']"))
            .button(byXpath("//div[@class='CustomJButton' and @name='jButtonRun']"), Duration.ofSeconds(2)).click();
        TimeUnit.SECONDS.sleep(5);
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='TaskScenePanelChart']"))
            .button(byXpath("//div[@class='CustomJButton' and @name='jButtonRun']"), Duration.ofSeconds(2)).click();
        TimeUnit.SECONDS.sleep(5);
