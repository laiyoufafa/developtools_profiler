...
/**
 * DiskIo Fold Button Test
 *
 * @since 2021/2/1 9:31
 */
public class DiskIoFoldButtonTest {
    private RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");

    /**
     * DiskIo Fold Button Test
     *
     * @tc.name: DiskIoFoldButtonTest
     * @tc.number: OHOS_JAVA_DiskIoFoldButtonTest_0001
     * @tc.desc: DiskIo Fold Button Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void DiskIoFoldButtonTest() throws InterruptedException {
