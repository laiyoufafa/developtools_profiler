...
public class ConnectTypeTest {
     ...
     * connect Type Test
     *
     * @tc.name: connectTypeTest
     * @tc.number: OHOS_JAVA_connectTypeTest_0001
     * @tc.desc: connect Type Test
     * @tc.type: functional testing
     * @tc.require: AR000FK5UI
     * @throws InterruptedException InterruptedException
     */
    @Test
    public void connectTypeTest() throws InterruptedException {
        ...
        remoteRobot.find(CommonContainerFixture.class, byXpath("//div[@class='ComboBox' and @name='connectType']"))
            .click();
