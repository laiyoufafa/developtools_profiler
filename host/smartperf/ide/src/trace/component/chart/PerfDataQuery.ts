...
import { queryPerfFiles, query, threadPool } from '../../database/SqlLite.js';
import {
    PerfCall,
    PerfCallChain,
...
export class PerfDataQuery {
    ...
    setCallChainName(callChain: PerfCallChain): string {
        //设置调用栈的名称
        ...
        if (callChain.symbolId == -1) {
            ...
            if (
                ...
                return this.filesData[callChain.fileId][callChain.symbolId]
                    .symbol;
            } else {
                callChain.fileName = 'unkown';
                return '+0x' + callChain.vaddrInFile;
