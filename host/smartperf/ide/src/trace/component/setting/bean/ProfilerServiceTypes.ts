...
export enum SysVMeminfoType {
    ...
    VMEMINFO_UNSPECIFIED = "VMEMPLUGIN_UNSPECIFIED",
    VMEMINFO_NR_FREE_PAGES = "VMEMPLUGIN_NR_FREE_PAGES",
    VMEMINFO_NR_ALLOC_BATCH = "VMEMPLUGIN_NR_ALLOC_BATCH",
    VMEMINFO_NR_INACTIVE_ANON = "VMEMPLUGIN_NR_INACTIVE_ANON",
    VMEMINFO_NR_ACTIVE_ANON = "VMEMPLUGIN_NR_ACTIVE_ANON",
    VMEMINFO_NR_INACTIVE_FILE = "VMEMPLUGIN_NR_INACTIVE_FILE",
    VMEMINFO_NR_ACTIVE_FILE = "VMEMPLUGIN_NR_ACTIVE_FILE",
    VMEMINFO_NR_UNEVICTABLE = "VMEMPLUGIN_NR_UNEVICTABLE",
    VMEMINFO_NR_MLOCK = "VMEMPLUGIN_NR_MLOCK",
    VMEMINFO_NR_ANON_PAGES = "VMEMPLUGIN_NR_ANON_PAGES",
    VMEMINFO_NR_MAPPED = "VMEMPLUGIN_NR_MAPPED",
    VMEMINFO_NR_FILE_PAGES = "VMEMPLUGIN_NR_FILE_PAGES",
    VMEMINFO_NR_DIRTY = "VMEMPLUGIN_NR_DIRTY",
    VMEMINFO_NR_WRITEBACK = "VMEMPLUGIN_NR_WRITEBACK",
    VMEMINFO_NR_SLAB_RECLAIMABLE = "VMEMPLUGIN_NR_SLAB_RECLAIMABLE",
    VMEMINFO_NR_SLAB_UNRECLAIMABLE = "VMEMPLUGIN_NR_SLAB_UNRECLAIMABLE",
    VMEMINFO_NR_PAGE_TABLE_PAGES = "VMEMPLUGIN_NR_PAGE_TABLE_PAGES",
    VMEMINFO_NR_KERNEL_STACK = "VMEMPLUGIN_NR_KERNEL_STACK",
    VMEMINFO_NR_OVERHEAD = "VMEMPLUGIN_NR_OVERHEAD",
    VMEMINFO_NR_UNSTABLE = "VMEMPLUGIN_NR_UNSTABLE",
    VMEMINFO_NR_BOUNCE = "VMEMPLUGIN_NR_BOUNCE",
    VMEMINFO_NR_VMSCAN_WRITE = "VMEMPLUGIN_NR_VMSCAN_WRITE",
    VMEMINFO_NR_VMSCAN_IMMEDIATE_RECLAIM = "VMEMPLUGIN_NR_VMSCAN_IMMEDIATE_RECLAIM",
    VMEMINFO_NR_WRITEBACK_TEMP = "VMEMPLUGIN_NR_WRITEBACK_TEMP",
    VMEMINFO_NR_ISOLATED_ANON = "VMEMPLUGIN_NR_ISOLATED_ANON",
    VMEMINFO_NR_ISOLATED_FILE = "VMEMPLUGIN_NR_ISOLATED_FILE",
    VMEMINFO_NR_SHMEM = "VMEMPLUGIN_NR_SHMEM",
    VMEMINFO_NR_DIRTIED = "VMEMPLUGIN_NR_DIRTIED",
    VMEMINFO_NR_WRITTEN = "VMEMPLUGIN_NR_WRITTEN",
    VMEMINFO_NR_PAGES_SCANNED = "VMEMPLUGIN_NR_PAGES_SCANNED",
    VMEMINFO_WORKINGSET_REFAULT = "VMEMPLUGIN_WORKINGSET_REFAULT",
    VMEMINFO_WORKINGSET_ACTIVATE = "VMEMPLUGIN_WORKINGSET_ACTIVATE",
    VMEMINFO_WORKINGSET_NODERECLAIM = "VMEMPLUGIN_WORKINGSET_NODERECLAIM",
    VMEMINFO_NR_ANON_TRANSPARENT_HUGEPAGES = "VMEMPLUGIN_NR_ANON_TRANSPARENT_HUGEPAGES",
    VMEMINFO_NR_FREE_CMA = "VMEMPLUGIN_NR_FREE_CMA",
    VMEMINFO_NR_SWAPCACHE = "VMEMPLUGIN_NR_SWAPCACHE",
    VMEMINFO_NR_DIRTY_THRESHOLD = "VMEMPLUGIN_NR_DIRTY_THRESHOLD",
    VMEMINFO_NR_DIRTY_BACKGROUND_THRESHOLD = "VMEMPLUGIN_NR_DIRTY_BACKGROUND_THRESHOLD",
    VMEMINFO_PGPGIN = "VMEMPLUGIN_PGPGIN",
    VMEMINFO_PGPGOUT = "VMEMPLUGIN_PGPGOUT",
    VMEMINFO_PGPGOUTCLEAN = "VMEMPLUGIN_PGPGOUTCLEAN",
    VMEMINFO_PSWPIN = "VMEMPLUGIN_PSWPIN",
    VMEMINFO_PSWPOUT = "VMEMPLUGIN_PSWPOUT",
    VMEMINFO_PGALLOC_DMA = "VMEMPLUGIN_PGALLOC_DMA",
    VMEMINFO_PGALLOC_NORMAL = "VMEMPLUGIN_PGALLOC_NORMAL",
    VMEMINFO_PGALLOC_MOVABLE = "VMEMPLUGIN_PGALLOC_MOVABLE",
    VMEMINFO_PGFREE = "VMEMPLUGIN_PGFREE",
    VMEMINFO_PGACTIVATE = "VMEMPLUGIN_PGACTIVATE",
    VMEMINFO_PGDEACTIVATE = "VMEMPLUGIN_PGDEACTIVATE",
    VMEMINFO_PGFAULT = "VMEMPLUGIN_PGFAULT",
    VMEMINFO_PGMAJFAULT = "VMEMPLUGIN_PGMAJFAULT",
    VMEMINFO_PGREFILL_DMA = "VMEMPLUGIN_PGREFILL_DMA",
    VMEMINFO_PGREFILL_NORMAL = "VMEMPLUGIN_PGREFILL_NORMAL",
    VMEMINFO_PGREFILL_MOVABLE = "VMEMPLUGIN_PGREFILL_MOVABLE",
    VMEMINFO_PGSTEAL_KSWAPD_DMA = "VMEMPLUGIN_PGSTEAL_KSWAPD_DMA",
    VMEMINFO_PGSTEAL_KSWAPD_NORMAL = "VMEMPLUGIN_PGSTEAL_KSWAPD_NORMAL",
    VMEMINFO_PGSTEAL_KSWAPD_MOVABLE = "VMEMPLUGIN_PGSTEAL_KSWAPD_MOVABLE",
    VMEMINFO_PGSTEAL_DIRECT_DMA = "VMEMPLUGIN_PGSTEAL_DIRECT_DMA",
    VMEMINFO_PGSTEAL_DIRECT_NORMAL = "VMEMPLUGIN_PGSTEAL_DIRECT_NORMAL",
    VMEMINFO_PGSTEAL_DIRECT_MOVABLE = "VMEMPLUGIN_PGSTEAL_DIRECT_MOVABLE",
    VMEMINFO_PGSCAN_KSWAPD_DMA = "VMEMPLUGIN_PGSCAN_KSWAPD_DMA",
    VMEMINFO_PGSCAN_KSWAPD_NORMAL = "VMEMPLUGIN_PGSCAN_KSWAPD_NORMAL",
    VMEMINFO_PGSCAN_KSWAPD_MOVABLE = "VMEMPLUGIN_PGSCAN_KSWAPD_MOVABLE",
    VMEMINFO_PGSCAN_DIRECT_DMA = "VMEMPLUGIN_PGSCAN_DIRECT_DMA",
    VMEMINFO_PGSCAN_DIRECT_NORMAL = "VMEMPLUGIN_PGSCAN_DIRECT_NORMAL",
    VMEMINFO_PGSCAN_DIRECT_MOVABLE = "VMEMPLUGIN_PGSCAN_DIRECT_MOVABLE",
    VMEMINFO_PGSCAN_DIRECT_THROTTLE = "VMEMPLUGIN_PGSCAN_DIRECT_THROTTLE",
    VMEMINFO_PGINODESTEAL = "VMEMPLUGIN_PGINODESTEAL",
    VMEMINFO_SLABS_SCANNED = "VMEMPLUGIN_SLABS_SCANNED",
    VMEMINFO_KSWAPD_INODESTEAL = "VMEMPLUGIN_KSWAPD_INODESTEAL",
    VMEMINFO_KSWAPD_LOW_WMARK_HIT_QUICKLY = "VMEMPLUGIN_KSWAPD_LOW_WMARK_HIT_QUICKLY",
    VMEMINFO_KSWAPD_HIGH_WMARK_HIT_QUICKLY = "VMEMPLUGIN_KSWAPD_HIGH_WMARK_HIT_QUICKLY",
    VMEMINFO_PAGEOUTRUN = "VMEMPLUGIN_PAGEOUTRUN",
    VMEMINFO_ALLOCSTALL = "VMEMPLUGIN_ALLOCSTALL",
    VMEMINFO_PGROTATED = "VMEMPLUGIN_PGROTATED",
    VMEMINFO_DROP_PAGECACHE = "VMEMPLUGIN_DROP_PAGECACHE",
    VMEMINFO_DROP_SLAB = "VMEMPLUGIN_DROP_SLAB",
    VMEMINFO_PGMIGRATE_SUCCESS = "VMEMPLUGIN_PGMIGRATE_SUCCESS",
    VMEMINFO_PGMIGRATE_FAIL = "VMEMPLUGIN_PGMIGRATE_FAIL",
    VMEMINFO_COMPACT_MIGRATE_SCANNED = "VMEMPLUGIN_COMPACT_MIGRATE_SCANNED",
    VMEMINFO_COMPACT_FREE_SCANNED = "VMEMPLUGIN_COMPACT_FREE_SCANNED",
    VMEMINFO_COMPACT_ISOLATED = "VMEMPLUGIN_COMPACT_ISOLATED",
    VMEMINFO_COMPACT_STALL = "VMEMPLUGIN_COMPACT_STALL",
    VMEMINFO_COMPACT_FAIL = "VMEMPLUGIN_COMPACT_FAIL",
    VMEMINFO_COMPACT_SUCCESS = "VMEMPLUGIN_COMPACT_SUCCESS",
    VMEMINFO_COMPACT_DAEMON_WAKE = "VMEMPLUGIN_COMPACT_DAEMON_WAKE",
    VMEMINFO_UNEVICTABLE_PGS_CULLED = "VMEMPLUGIN_UNEVICTABLE_PGS_CULLED",
    VMEMINFO_UNEVICTABLE_PGS_SCANNED = "VMEMPLUGIN_UNEVICTABLE_PGS_SCANNED ",
    VMEMINFO_UNEVICTABLE_PGS_RESCUED = "VMEMPLUGIN_UNEVICTABLE_PGS_RESCUED",
    VMEMINFO_UNEVICTABLE_PGS_MLOCKED = "VMEMPLUGIN_UNEVICTABLE_PGS_MLOCKED",
    VMEMINFO_UNEVICTABLE_PGS_MUNLOCKED = "VMEMPLUGIN_UNEVICTABLE_PGS_MUNLOCKED",
    VMEMINFO_UNEVICTABLE_PGS_CLEARED = "VMEMPLUGIN_UNEVICTABLE_PGS_CLEARED",
    VMEMINFO_UNEVICTABLE_PGS_STRANDED = "VMEMPLUGIN_UNEVICTABLE_PGS_STRANDED",
    VMEMINFO_NR_ZSPAGES = "VMEMPLUGIN_NR_ZSPAGES",
    VMEMINFO_NR_ION_HEAP = "VMEMPLUGIN_NR_ION_HEAP",
    VMEMINFO_NR_GPU_HEAP = "VMEMPLUGIN_NR_GPU_HEAP",
    VMEMINFO_ALLOCSTALL_DMA = "VMEMPLUGIN_ALLOCSTALL_DMA",
    VMEMINFO_ALLOCSTALL_MOVABLE = "VMEMPLUGIN_ALLOCSTALL_MOVABLE",
    VMEMINFO_ALLOCSTALL_NORMAL = "VMEMPLUGIN_ALLOCSTALL_NORMAL",
    VMEMINFO_COMPACT_DAEMON_FREE_SCANNED = "VMEMPLUGIN_COMPACT_DAEMON_FREE_SCANNED",
    VMEMINFO_COMPACT_DAEMON_MIGRATE_SCANNED = "VMEMPLUGIN_COMPACT_DAEMON_MIGRATE_SCANNED",
    VMEMINFO_NR_FASTRPC = "VMEMPLUGIN_NR_FASTRPC",
    VMEMINFO_NR_INDIRECTLY_RECLAIMABLE = "VMEMPLUGIN_NR_INDIRECTLY_RECLAIMABLE",
    VMEMINFO_NR_ION_HEAP_POOL = "VMEMPLUGIN_NR_ION_HEAP_POOL",
    VMEMINFO_NR_KERNEL_MISC_RECLAIMABLE = "VMEMPLUGIN_NR_KERNEL_MISC_RECLAIMABLE",
    VMEMINFO_NR_SHADOW_CALL_STACK_BYTES = "VMEMPLUGIN_NR_SHADOW_CALL_STACK_BYTES",
    VMEMINFO_NR_SHMEM_HUGEPAGES = "VMEMPLUGIN_NR_SHMEM_HUGEPAGES",
    VMEMINFO_NR_SHMEM_PMDMAPPED = "VMEMPLUGIN_NR_SHMEM_PMDMAPPED",
    VMEMINFO_NR_UNRECLAIMABLE_PAGES = "VMEMPLUGIN_NR_UNRECLAIMABLE_PAGES",
    VMEMINFO_NR_ZONE_ACTIVE_ANON = "VMEMPLUGIN_NR_ZONE_ACTIVE_ANON",
    VMEMINFO_NR_ZONE_ACTIVE_FILE = "VMEMPLUGIN_NR_ZONE_ACTIVE_FILE",
    VMEMINFO_NR_ZONE_INACTIVE_ANON = "VMEMPLUGIN_NR_ZONE_INACTIVE_ANON",
    VMEMINFO_NR_ZONE_INACTIVE_FILE = "VMEMPLUGIN_NR_ZONE_INACTIVE_FILE",
    VMEMINFO_NR_ZONE_UNEVICTABLE = "VMEMPLUGIN_NR_ZONE_UNEVICTABLE",
    VMEMINFO_NR_ZONE_WRITE_PENDING = "VMEMPLUGIN_NR_ZONE_WRITE_PENDING",
    VMEMINFO_OOM_KILL = "VMEMPLUGIN_OOM_KILL ",
    VMEMINFO_PGLAZYFREE = "VMEMPLUGIN_PGLAZYFREE",
    VMEMINFO_PGLAZYFREED = "VMEMPLUGIN_PGLAZYFREED",
    VMEMINFO_PGREFILL = "VMEMPLUGIN_PGREFILL",
    VMEMINFO_PGSCAN_DIRECT = "VMEMPLUGIN_PGSCAN_DIRECT",
    VMEMINFO_PGSCAN_KSWAPD = "VMEMPLUGIN_PGSCAN_KSWAPD",
    VMEMINFO_PGSKIP_DMA = "VMEMPLUGIN_PGSKIP_DMA",
    VMEMINFO_PGSKIP_MOVABLE = "VMEMPLUGIN_PGSKIP_MOVABLE",
    VMEMINFO_PGSKIP_NORMAL = "VMEMPLUGIN_PGSKIP_NORMAL",
    VMEMINFO_PGSTEAL_DIRECT = "VMEMPLUGIN_PGSTEAL_DIRECT",
    VMEMINFO_PGSTEAL_KSWAPD = "VMEMPLUGIN_PGSTEAL_KSWAPD",
    VMEMINFO_SWAP_RA = "VMEMPLUGIN_SWAP_RA",
    VMEMINFO_SWAP_RA_HIT = "VMEMPLUGIN_SWAP_RA_HIT",
    VMEMINFO_WORKINGSET_RESTORE = "VMEMPLUGIN_WORKINGSET_RESTORE",
}

export enum SysMeminfoType {
    MEMINFO_UNSPECIFIED = "MEMPLUGIN_UNSPECIFIED",
    MEMINFO_MEM_TOTAL = "MEMPLUGIN_MEM_TOTAL",
    MEMINFO_MEM_FREE = "MEMPLUGIN_MEM_FREE",
    MEMINFO_MEM_AVAILABLE = "MEMPLUGIN_MEM_AVAILABLE",
    MEMINFO_BUFFERS = "MEMPLUGIN_BUFFERS",
    MEMINFO_CACHED = "MEMPLUGIN_CACHED",
    MEMINFO_SWAP_CACHED = "MEMPLUGIN_SWAP_CACHED",
    MEMINFO_ACTIVE = "MEMPLUGIN_ACTIVE",
    MEMINFO_INACTIVE = "MEMPLUGIN_INACTIVE",
    MEMINFO_ACTIVE_ANON = "MEMPLUGIN_ACTIVE_ANON",
    MEMINFO_INACTIVE_ANON = "MEMPLUGIN_INACTIVE_ANON",
    MEMINFO_ACTIVE_FILE = "MEMPLUGIN_ACTIVE_FILE",
    MEMINFO_INACTIVE_FILE = "MEMPLUGIN_INACTIVE_FILE",
    MEMINFO_UNEVICTABLE = "MEMPLUGIN_UNEVICTABLE",
    MEMINFO_MLOCKED = "MEMPLUGIN_MLOCKED",
    MEMINFO_SWAP_TOTAL = "MEMPLUGIN_SWAP_TOTAL",
    MEMINFO_SWAP_FREE = "MEMPLUGIN_SWAP_FREE",
    MEMINFO_DIRTY = "MEMPLUGIN_DIRTY",
    MEMINFO_WRITEBACK = "MEMPLUGIN_WRITEBACK",
    MEMINFO_ANON_PAGES = "MEMPLUGIN_ANON_PAGES",
    MEMINFO_MAPPED = "MEMPLUGIN_MAPPED",
    MEMINFO_SHMEM = "MEMPLUGIN_SHMEM",
    MEMINFO_SLAB = "MEMPLUGIN_SLAB",
    MEMINFO_SLAB_RECLAIMABLE = "MEMPLUGIN_SLAB_RECLAIMABLE",
    MEMINFO_SLAB_UNRECLAIMABLE = "MEMPLUGIN_SLAB_UNRECLAIMABLE",
    MEMINFO_KERNEL_STACK = "MEMPLUGIN_KERNEL_STACK",
    MEMINFO_PAGE_TABLES = "MEMPLUGIN_PAGE_TABLES",
    MEMINFO_COMMIT_LIMIT = "MEMPLUGIN_COMMIT_LIMIT",
    MEMINFO_COMMITED_AS = "MEMPLUGIN_COMMITED_AS",
    MEMINFO_VMALLOC_TOTAL = "MEMPLUGIN_VMALLOC_TOTAL",
    MEMINFO_VMALLOC_USED = "MEMPLUGIN_VMALLOC_USED",
    MEMINFO_VMALLOC_CHUNK = "MEMPLUGIN_VMALLOC_CHUNK",
    MEMINFO_CMA_TOTAL = "MEMPLUGIN_CMA_TOTAL",
    MEMINFO_CMA_FREE = "MEMPLUGIN_CMA_FREE",
    UNRECOGNIZED = "UNRECOGNIZED",
}
