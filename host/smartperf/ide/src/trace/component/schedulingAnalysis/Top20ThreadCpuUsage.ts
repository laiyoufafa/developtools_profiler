...
export class Top20ThreadCpuUsage extends BaseElement {
    ...
    private map:
        | Map<string, { chart: LitChartColumn; table: LitTable }>
        | undefined;
    ...
    initElements(): void {
        ...
        this.table =
            this.shadowRoot!.querySelector<LitTable>('#tb-thread-usage');
        this.tableBig =
            this.shadowRoot!.querySelector<LitTable>('#tb-thread-big');
        this.tableMid =
            this.shadowRoot!.querySelector<LitTable>('#tb-thread-mid');
        this.tableSmall =
            this.shadowRoot!.querySelector<LitTable>('#tb-thread-small');
        this.chartTotal =
            this.shadowRoot!.querySelector<LitChartColumn>('#chart_total');
        this.chart2 =
            this.shadowRoot!.querySelector<LitChartColumn>('#chart_2');
        this.chart3 =
            this.shadowRoot!.querySelector<LitChartColumn>('#chart_3');
        this.chart4 =
            this.shadowRoot!.querySelector<LitChartColumn>('#chart_4');
        this.map = new Map<
            string,
            { chart: LitChartColumn; table: LitTable }
        >();
        ...
        this.setting =
            this.shadowRoot!.querySelector<HTMLDivElement>('#setting');
        this.cpuSetting =
            this.shadowRoot!.querySelector<CheckCpuSetting>('#cpu_setting');
        this.cpuSetting!.cpuSetListener = () => {
            this.cpuSetting!.style.display = 'none';
            (this.shadowRoot!.querySelector('#total')! as any).style.display =
                'grid';
    ...
    queryData() {
        ...
        this.queryLogicWorker(
            `scheduling-Thread CpuUsage`,
            `query Thread Cpu Usage Analysis Time:`,
            (res) => {
                    ...
                    source = source.map((it: any, index: number) => {
                        let data: any = {
                            ...
                            hideHandler: () => {
                                ...
                                obj.chart.dataSource = this.getArrayDataBySize(
                                    key,
                                    arr
                                );
                            },
                        ...
                        for (
                            let i = 0;
                            i < SpSchedulingAnalysis.cpuCount;
                            i++
                        ) {
