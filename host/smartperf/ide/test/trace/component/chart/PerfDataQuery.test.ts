...
describe('perfDataQuery Test', () => {
    ...
    it('perfDataQueryTest02 ', function () {
        ...
        expect(
            perfDataQuery.addProcessThreadStateData(callChain)
        ).toBeUndefined();
    });
    ...
    it('perfDataQueryTest03 ', function () {
        ...
        expect(
            perfDataQuery.getCallChainsBySampleIds([{ length: 1 }], true)
        ).not.toBeUndefined();
    });
    ...
    it('perfDataQueryTest06 ', function () {
        ...
        expect(
            perfDataQuery.merageChildren(currentNode, callChain, true)
        ).toBeUndefined();
    });
    ...
    it('perfDataQueryTest17 ', function () {
        ...
        expect(
            perfDataQuery.initCallChainBottomUp(callChainsData)
        ).toBeUndefined();
    });
    ...
    it('perfDataQueryTest19 ', function () {
        ...
        expect(
            perfDataQuery.setCallChainName(callChainsData)
        ).not.toBeUndefined();
    });
    ...
    it('perfDataQueryTest21 ', function () {
        ...
        expect(
            perfDataQuery.getCallChainsBySampleIds(sampleIds, true)
        ).not.toBeUndefined();
    });
    ...
    it('perfDataQueryTest12 ', function () {
        ...
        expect(
            perfDataQuery.merageChildren(currentData, callChainsData, true)
        ).toBeUndefined();
    });
    it('perfDataQueryTest14 ', function () {
        let node = {
        ...
        expect(
            perfDataQuery.recursionChargeInitTree(node, '', true)
        ).toBeUndefined();
    });
    ...
    it('perfDataQueryTest15 ', function () {
        ...
        expect(
            perfDataQuery.recursionChargeTree(node, '', true)
        ).toBeUndefined();
    });
    ...
    it('perfDataQueryTest16 ', function () {
        ...
        expect(
            perfDataQuery.recursionPruneInitTree(node, '', true)
        ).toBeUndefined();
    });
    ...
    it('perfDataQueryTest17 ', function () {
        ...
        expect(
            perfDataQuery.recursionPruneTree(node, '', true)
        ).toBeUndefined();
    });
    ...
    it('perfDataQueryTest18 ', function () {
        ...
        expect(
            perfDataQuery.recursionChargeByRule(node, '', true)
        ).toBeUndefined();
    });
