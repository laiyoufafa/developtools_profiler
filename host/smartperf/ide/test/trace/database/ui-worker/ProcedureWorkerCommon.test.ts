...
jest.mock(
    '../../../../dist/trace/database/ui-worker/ProcedureWorkerCPU.js',
    () => {}
);
jest.mock(
    '../../../../dist/trace/component/trace/base/TraceSheet.js',
    () => {}
);
...
Window.prototype.clearTraceRowComplete = () =>
    EventCenter.clearTraceRowComplete();
...
describe('ProcedureWorkerCommon Test', () => {
    ...
    let timerShaftElement = document.querySelector(
        '#timerShaftEL'
    ) as TimerShaftElement;
    ...
    it('ProcedureWorkerCommon28', function () {
        ...
        expect(
            drawFlagLine(ctx, flag, select, 1, 2, 1, frame, slicesTime)
        ).toBeUndefined();
    });
    ...
    it('ProcedureWorkerCommon36', function () {
        ...
        expect(
            drawLinkLines(context, nodes, timerShaftElement)
        ).toBeUndefined();
    });
});
