...
describe('ProcedureWorkerHiPerfReport Test', () => {
    ...
    it('ProcedureWorkerHiPerfReportTest03', () => {
        ...
        expect(
            HiPerfReportStruct.drawRoundRectPath(ctx, 1, 0, 10, 10, 12)
        ).toBeUndefined();
    });
    ...
    it('ProcedureWorkerHiPerfReportTest04', function () {
        ...
        expect(
            HiPerfReportStruct.setFrame(node, 2, 1, 2, frame)
        ).toBeUndefined();
    });
    ...
    it('ProcedureWorkerHiPerfReportTest06', function () {
        expect(
            HiPerfReportStruct.groupBy10MS([{ ps: 1 }, { coX: '1' }], 10, '')
        ).toEqual([{ dur: 10000000, height: NaN, startNS: NaN, sum: NaN }]);
    });
});
