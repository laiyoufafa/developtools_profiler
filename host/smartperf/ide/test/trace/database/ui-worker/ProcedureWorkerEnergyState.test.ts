...
describe('ProcedureWorkerEnergyState Test', () => {
    ...
    it('ProcedureWorkerEnergyStateTest04', function () {
        expect(EnergyStateStruct.setDrawColor('BRIGHTNESS_NIT')).toBe(
            '#92D6CC'
        );
    });
    ...
    it('ProcedureWorkerEnergyStateTest06', function () {
        expect(EnergyStateStruct.setDrawColor('WIFI_EVENT_RECEIVED')).toBe(
            '#46B1E3'
        );
    });

    it('ProcedureWorkerEnergyStateTest07', function () {
        expect(EnergyStateStruct.setDrawColor('AUDIO_STREAM_CHANGE')).toBe(
            '#ED6F21'
        );
    });
    ...
    it('ProcedureWorkerEnergyStateTest09', function () {
        expect(EnergyStateStruct.setDrawColor('LOCATION_SWITCH_STATE')).toBe(
            '#61CFBE'
        );
    });
