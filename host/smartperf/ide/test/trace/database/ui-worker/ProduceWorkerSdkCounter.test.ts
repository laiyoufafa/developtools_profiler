...
import {
    SdkCounterRender,
    CounterStruct,
} from '../../../../dist/trace/database/ui-worker/ProduceWorkerSdkCounter.js';
...
describe('ProduceWorkerSdkCounter Test', () => {
    it('ProduceWorkerSdkCounterTest01', function () {
        ...
        expect(
            sdkCounterRender.counter(List, arr, 1, 1, 1, frame, true)
        ).toBeUndefined();
    });
    ...
    it('ProduceWorkerSdkCounterTest02', function () {
        ...
        expect(
            sdkCounterRender.counter(List, arr, 1, 1, 1, frame, false)
        ).toBeUndefined();
    });
    ...
    it('ProduceWorkerSdkCounterTest04', () => {
        ...
        expect(
            CounterStruct.setCounterFrame(node, 2, 1, 2, 2, frame)
        ).toBeUndefined();
    });
