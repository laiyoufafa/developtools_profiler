...
describe('ProcedureLogicWorkerNativeNemory Test', () => {
    ...
    it('ProcedureLogicWorkerNativeNemoryTest10', function () {
        ...
        expect(
            procedureLogicWorkerNativeMemory.listToTree(target, src)
        ).toBeUndefined();
    });
    ...
    it('ProcedureLogicWorkerNativeNemoryTest11', function () {
        let procedureLogicWorkerNativeMemory =
            new ProcedureLogicWorkerNativeMemory();
        expect(
            procedureLogicWorkerNativeMemory.getTypeFromIndex(-1, '', '')
        ).toBeFalsy();
    });
    ...
    it('ProcedureLogicWorkerNativeNemoryTest12', function () {
        let procedureLogicWorkerNativeMemory =
            new ProcedureLogicWorkerNativeMemory();
        expect(
            procedureLogicWorkerNativeMemory.getTypeFromIndex(0, '', '')
        ).toBeTruthy();
    });
    ...
    it('ProcedureLogicWorkerNativeNemoryTest13', function () {
        ...
        expect(
            procedureLogicWorkerNativeMemory.getTypeFromIndex(1, item, '')
        ).toBeTruthy();
    });
    ...
    it('ProcedureLogicWorkerNativeNemoryTest14', function () {
        ...
        expect(
            procedureLogicWorkerNativeMemory.getTypeFromIndex(2, item, '')
        ).toBeTruthy();
    });
    ...
    it('ProcedureLogicWorkerNativeNemoryTest15', function () {
        ...
        expect(
            procedureLogicWorkerNativeMemory.traverseTree(stack, 1)
        ).toBeUndefined();
    });
    ...
    it('ProcedureLogicWorkerNativeNemoryTest16', function () {
        ...
        expect(
            procedureLogicWorkerNativeMemory.traverseSampleTree(stack, 1)
        ).toBeUndefined();
    });
    ...
    it('ProcedureLogicWorkerNativeNemoryTest17', function () {
        ...
        expect(
            procedureLogicWorkerNativeMemory.mergeTree(target, src)
        ).toBeUndefined();
    });
