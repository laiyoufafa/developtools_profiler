...
import { TIndexInfo, GPData, TGenneralInfo } from '../entity/DatabaseEntity';
import { sql_t_index_info, dbPath, dbVersion } from '../constant/ConstantSQL'
...
export default {
    ...
    //插入表( T_GENERAL_INFO)
    insertGeneraData(tableName: string, tGenneralInfo: TGenneralInfo) {
        var strMap = new Map;
        ...
        dataRdb.getRdbStore(globalThis.abilityContext, STORE_CONFIG, dbVersion, (err, rdbStore) => {
            ...
            rdbStore.insert(tableName, valueInsert).catch(err => {
                ...
                console.log(TAG + "--> insert into  insertGeneraData success:")
            })
        })
    },
