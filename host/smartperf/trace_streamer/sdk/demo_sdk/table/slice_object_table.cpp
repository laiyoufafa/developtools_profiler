...
// void SliceObjectTable::EstimateFilterCost(FilterConstraints& fc, EstimatedIndexInfo& ei)
// {
//     constexpr double filterBaseCost = 1000.0; // set-up and tear-down
//     constexpr double indexCost = 2.0;
//     ei.estimatedCost = filterBaseCost;

//     auto rowCount = dataCache_->GetConstSliceObjectData().Size();
...
// void SliceObjectTable::FilterByConstraint(FilterConstraints& fc, double& filterCost, size_t rowCount)
// {
...
// bool SliceObjectTable::CanFilterId(const char op, size_t& rowCount)
// {
//     switch (op) {
...
// int SliceObjectTable::Cursor::Filter(const FilterConstraints& fc, sqlite3_value** argv)
// {
//     // reset indexMap_
