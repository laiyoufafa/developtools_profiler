...
int SDKDataParser::AppendCounter(int counterId, uint64_t ts, double value)
{
...
int SDKDataParser::AppendSlice(int sliceId, uint64_t ts, uint64_t endTs, std::string start_time, std::string end_time, double value)
{
    auto newTs = streamFilters_->clockFilter_->ToPrimaryTraceTime(TS_CLOCK_REALTIME, ts);
