...
void HtraceDiskIOParser::Parse(DiskioData& tracePacket, uint64_t ts)
{
    auto stat = tracePacket.statsdata();
    ...
    diskIOData_.push_back(TsDiskIOData{ts, tracePacket.rd_sectors_kb(), tracePacket.wr_sectors_kb(),
                                       tracePacket.prev_rd_sectors_kb(), tracePacket.prev_wr_sectors_kb(),
