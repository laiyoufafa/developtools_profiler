...
#ifndef SYMBOLS_DICT_TABLE_H
#define SYMBOLS_DICT_TABLE_H
...
class SymbolsTable : public TableBase {
public:
    explicit SymbolsTable(const TraceDataCache* dataCache);
    ~SymbolsTable() override;
