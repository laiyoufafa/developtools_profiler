...
class PerfFilesTable : public TableBase {
public:
    explicit PerfFilesTable(const TraceDataCache* dataCache);
    ~PerfFilesTable() override;
...
private:
    ...
    private:
        const PerfFiles& perfFilesObj_;
    };
};
} // namespace TraceStreamer
} // namespace SysTuning
#endif // PERF_FILES_TABLE_H
