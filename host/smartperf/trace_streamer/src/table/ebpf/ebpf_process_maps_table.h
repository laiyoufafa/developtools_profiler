 ...
 */
#ifndef EBPF_PROCESS_MAPS_TABLE_H
#define EBPF_PROCESS_MAPS_TABLE_H
...
class EbpfProcessMapsTable : public TableBase {
public:
    explicit EbpfProcessMapsTable(const TraceDataCache* dataCache);
    ~EbpfProcessMapsTable() override;
...
private:
    ...
    private:
        const EbpfProcessMaps& ebpfProcessMapsObj_;
    };
};
} // namespace TraceStreamer
} // namespace SysTuning
#endif // EBPF_PROCESS_MAPS_TABLE_H
