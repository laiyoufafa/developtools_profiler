...
bool FrameSliceTable::CanFilterId(const char op, size_t& rowCount)
{
    switch (op) {
...
int FrameSliceTable::Cursor::Filter(const FilterConstraints& fc, sqlite3_value** argv)
{
    // reset indexMap_
...
int FrameSliceTable::Cursor::Column(int column) const
{
    switch (column) {
        case ID:
