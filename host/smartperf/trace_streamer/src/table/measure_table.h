...
#ifndef MEASURE_TABLE_H
#define MEASURE_TABLE_H
...
class MeasureTable : public TableBase {
public:
    explicit MeasureTable(const TraceDataCache* dataCache);
    ~MeasureTable() override;
...
private:
    ...
    public:
        ...
        void FilterFilterId(unsigned char op, uint64_t value);
