...
#ifndef LIVE_PROCESS_TABLE_H
#define LIVE_PROCESS_TABLE_H
...
class LiveProcessTable : public TableBase {
public:
    explicit LiveProcessTable(const TraceDataCache* dataCache);
    ~LiveProcessTable() override;
