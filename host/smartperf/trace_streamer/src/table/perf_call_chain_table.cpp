...
bool PerfCallChainTable::CanFilterId(const char op, size_t& rowCount)
{
    switch (op) {
...
int PerfCallChainTable::Cursor::Filter(const FilterConstraints& fc, sqlite3_value** argv)
{
    // reset indexMap_
...
int PerfCallChainTable::Cursor::Column(int column) const
{
    switch (column) {
        case ID:
