...
void DataTypeTable::EstimateFilterCost(FilterConstraints& fc, EstimatedIndexInfo& ei)
{
    constexpr double filterBaseCost = 1000.0; // set-up and tear-down
    constexpr double indexCost = 2.0;
    ei.estimatedCost = filterBaseCost;

    auto rowCount = dataCache_->GetConstDataTypeData().Size();
...
void DataTypeTable::FilterByConstraint(FilterConstraints& fc, double& filterCost, size_t rowCount)
{
...
bool DataTypeTable::CanFilterId(const char op, size_t& rowCount)
{
    switch (op) {
...
int DataTypeTable::Cursor::Filter(const FilterConstraints& fc, sqlite3_value** argv)
{
    // reset indexMap_
...
void DataTypeTable::Cursor::FilterId(unsigned char op, sqlite3_value* argv)
{
